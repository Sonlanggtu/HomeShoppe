...
namespace HomeShoppe
{
    public partial class gio_hang : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // delete gio hang
            int removeSP = 0;
            removeSP = Convert.ToInt32(Request.QueryString["RemoveproductID"]);
            if(removeSP != 0)
            {
                var sessionCart = (List<CartItem>)Session[CartSession];
                sessionCart.RemoveAll(x => x.Product.ID == removeSP);
            ...
            if (cart != null)
            {
                ...
                {                  
                    ...
                    stringGioHang += "<a href='/gio-hang?RemoveproductID=" + list[i].Product.ID + "' class='btn btn-danger'>Xóa</a>";
