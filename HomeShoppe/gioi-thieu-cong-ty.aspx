<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gioi-thieu-cong-ty.aspx.cs" Inherits="HomeShoppe.Page.Client.gioithieucongty" %>
...
<body>
    <form id="form1" runat="server">
        <!--Start Tag Wrap--->
        <div class="Wrap_Header_Content_About">
            <!--Start Tag Topbar-->
            <div class="TopBar">
                <!--Start tag hotline-->
                <div class="hotline">
            ...
            <div class="MainAbout">
                ...
                <div class="LinkDetailProduct cantheLinkProduct">
                    <ul class="cankhoi ">
                        ...
                        <li><a href="gioi-thieu-cong-ty.aspx"><i class="fas fa-angle-double-right"></i><span>GiớiThiệu</span></a></li>
                    </ul>
                </div>
                <!--End Tag LinkDetailProduct-->
                <asp:Literal ID="LtContentPageAbout" runat="server"></asp:Literal>
            </div>
            <!--End Tag Main-->
        </div>
        <!--End Tag Wrap--->
