<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="HomeShoppe.ProductCategory.Default" %>
        ...
        <div class="Wrap_Header_Content_ProductCategory">
            ...
            <div class="MainAbout">
                ...
                <div class="LinkDetailProduct cantheLinkProduct">
                    <ul class="cankhoi ">
                        <asp:Literal ID="LtLinkPage" runat="server"></asp:Literal>
                    </ul>
                </div>
                ...
                <div class="Sapxep">
                    ...
                    <div class="Sapxepheader">
                        <select name="sapxeptheo" id="se_sapxep" onchange="sapxepFun()" class="form-control">
                            ...
                            <option value="theo_ngay_ra">theo ngày ra mắt</option>                      
                        </select>
                    </div>
                ...
                <div class="section_group2">
                    <asp:Literal ID="LtProductCategpry" runat="server"></asp:Literal>
                </div>
                <!--End Danh muc sp-->
...
<script> 
    $(document).ready(function () {
        $('#se_sapxep').on('change', function () {
            var value_sapxep = $('#se_sapxep').val();
            var productcategory =$('.productcategory').val();       
        var xhttp;       
        xhttp = new XMLHttpRequest();
        window.location.replace("/Productcategory?productcategory="+productcategory+"&sapxeptheo=" + value_sapxep);
        })
    })
</script>
