<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="san-pham-hot.aspx.cs" Inherits="HomeShoppe.Page.Client.ProductCategoryHome.PCHot" %>
                ...
                <div class="MainAbout">
                    ...
                    <div class="LinkDetailProduct cantheLinkProduct">
                        <ul class="cankhoi ">
                            ...
                            <li><a href="san-pham-hot"><i class="fas fa-angle-double-right"></i>SPHot</a></li>
                        </ul>
                    </div>
