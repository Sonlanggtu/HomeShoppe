<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/PageGeneric.Master" AutoEventWireup="true" CodeBehind="tai-khoan-quan-tri.aspx.cs" Inherits="HomeShoppe.Admin.tai_khoan_quan_tri" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <div class="row">
        <div class="col-lg-12">
            <div class="white-box">
                <h3 class="box-title">Quản Lí Tài Khoản Người Quản Trị</h3>
            </div>
            <table class="col-lg-12">
                <thead class="thead-dark">
                    <tr class="box-title">
                        <th class="col-lg-4" style="text-align: center" scope="row">Tên Tài Khoản</th>
                ...
                <tbody>
                    <asp:Literal ID="LtTaiKhoanQuanTri" runat="server"></asp:Literal>
                </tbody>
            </table>
        </div>
    </div>
     ...
     <script>
        ...
        $(document).ready(function () {
            ...
            $('.lock_account_client').off('click').on('click', function () {
                ...
                window.location.replace("/Admin/tai-khoan-quan-tri/?username=" + username);
                //$.ajax({
