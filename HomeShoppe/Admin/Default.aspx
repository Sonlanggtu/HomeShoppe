<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="HomeShoppe.Admin.Default" %>
        ...
        <div class="MainRigister">
            ...
            <div class="contentRigister">
                ...
                <div class="pageheader_Register">
                    <p class="Thamgia_dangky">Xin mời đăng nhập trang quản trị</p>
                </div>
                    ...
                    <div class="login_form">
                        <h3>Đăng nhập</h3>                  
                            <div class="form-group">
                                <div class="form-control">
                                    <div class="input-icon">
                                        ...
                                        <input type="text"  id="txtUsername" name="Username" placeholder="Tên tài khoản" />
                            ...
                            <div class="form-group">
                                <div class="form-control">
                                    <div class="input-icon">
                                     ...
                                     <input type="password" id="txtPassword" name="Password" placeholder="Mật khẩu" />
                            ...
                            <div class="btnRegister">                               
                             ...
                             <%-- <asp:Button runat="server" Text="Đăng Nhập" OnClick="Page_Load" Width="114px"/>--%>
                            </div>
                    </div>
