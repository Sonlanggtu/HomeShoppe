<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="san-pham-sale.aspx.cs" Inherits="HomeShoppe.Page.Client.ProductCategoryHome.PCSale" %>
                ...
                <div class="MainAbout">
                    ...
                    <div class="LinkDetailProduct cantheLinkProduct">
                        <ul class="cankhoi ">
                            ...
                            <li><a href="san-pham-sale"><i class="fas fa-angle-double-right"></i>SPGiamGia</a></li>
                        </ul>
                    </div>
